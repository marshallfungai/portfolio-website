    ...
    return (
        ...
        >
           ...
           overflow-hidden sm:pr-8 relative sm:h-[25rem]  group-even:pl-8 hover:bg-gray-200 transition'
            >
                <div className='pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[55%] flex flex-col h-full  group-even:ml-[10rem] group-even:sm:ml-[20rem] group-odd:mr-[12rem]'>
                ...
                <Image className='absolute top-8 -right-40 w-[20.25rem] rounded-lg shadow-2xl 
                    sm:w-[32.25rem]
